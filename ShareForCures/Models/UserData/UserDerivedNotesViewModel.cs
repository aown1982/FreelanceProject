...
{
    public class UserDataNotesViewModel
    {
        ...
        public tUserInstructionViewModel FollowUpInstruction { get; set; }
        public tUserInstructionViewModel PatientInstruction { get; set; }
