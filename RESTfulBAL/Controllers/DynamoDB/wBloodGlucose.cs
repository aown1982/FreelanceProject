...
{
    public class wBloodGlucoseController : ApiController
    {
        private UserDataEntities db = new UserDataEntities();
        private UserDataEntities dbErr = new UserDataEntities();

        // POST: api/DynamoDB/wBloodGlucose
        [Route("api/DynamoDB/wBloodGlucose")]
            ...
            using (var dbContextTransaction = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (userTestResult == null)
                    {
                        ...
                        if (userTestResult.Narrative != null) userTestResult.Narrative += " | ";
