...
namespace RESTfulBAL.Models.DynamoDB
{
    public static partial class Utilities
    {
        ...
        public static bool ConvertToDateTimeOffset(string sTimeStamp, string utcOffset,
        ...
        public static bool ConvertToDateTimeOffset(DateTimeOffset timeStamp, string utcOffset,
            out DateTimeOffset newTimeStamp)
        {
            newTimeStamp = DateTimeOffset.MinValue;
            var s = timeStamp.DateTime + utcOffset;
