...
{
    public class UserAcitivityModel
    {
        ...
        public tUserDerivedNote UserDerivedNote { get; set; }
        public string Note
        {
            get
            {
                if (UserDerivedNote != null)
                {
                    return UserDerivedNote.Note;
                }
                return null;
            }
        }
